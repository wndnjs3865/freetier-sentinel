...
const ko: Translations = {
  ...
  hero_sub_line1: "Datadog 같은 모니터링을, 무료 플랜 한도에.",
  hero_sub_line2: "사용량 80%에서 이메일로 미리 알려 드립니다. 한도에 도달하기 전에.",
  hero_email_placeholder: "you@example.com",
  hero_cta: "시작하기 →",
  ...
  features_h2_line1: "무료 플랜 위에서 실서비스를 굴리는",
  ...
  cta_h2: "한 화면에서 모두 확인. 새벽 한도 초과는 이제 그만.",
...
const es: Translations = {
  ...
  hero_sub_line2: "Te avisamos por correo al 80 % de consumo, antes de llegar al tope.",
  ...
  strip_label: "Servicios que monitorizamos",
  ...
  tier_pro_cta: "Empieza gratis, mejora cuando lo necesites",
  ...
  faqs: [
    ...
    { q: "¿Qué pasa al llegar al 100 %? ¿Cortáis vosotros la petición?", a: "No. No tenemos permisos para controlar tus servicios, y es algo deliberado. Te avisamos al 80 % (valor por defecto, configurable) para que puedas decidir: ampliar el plan, optimizar el tráfico o asumir el corte de servicio." },
