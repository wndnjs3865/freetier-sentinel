...
const ko: Translations = {
  ...
  hero_sub_line1: "Datadog의 접근 방식을, 무료 등급 한도에.",
  hero_sub_line2: "한도 도달 전, 사용량 80%에서 이메일로 알려 드립니다.",
  hero_email_placeholder: "you@example.com",
  hero_cta: "시작하기 →",
  ...
  features_h2_line1: "무료 등급 위에서 실서비스를 운영하는",
  features_h2_line2: "인디 개발자를 위해.",
  features_sub: "모든 클라우드에 사용량 페이지는 있지만, 한도 도달 전에 알려주는 곳은 없습니다. Sentinel은 다릅니다.",
  features: [
    { title: "한도 도달 전 알림", desc: "기본 임곗값 80%, 이메일 즉시 발송. Pro 플랜에서는 Discord와 Telegram도 지원됩니다. 새벽 11시 사이트 다운 알림은 이제 끝." },
  ...
  tier_pro_sub: "무료 등급 위에서 실서비스를 운영하는 분들을 위한 플랜.",
  tier_pro_features: [
    "무제한 서비스 연결",
    "1시간마다 폴링",
  ...
  code_h2: "모니터링 대상과 동일한 무료 등급 위에서 동작합니다.",
  ...
  faqs: [
    ...
    { q: "왜 평생 무료가 아니라 월 $5입니까?", a: "무제한 서비스에 대한 시간 단위 폴링과 Discord·Telegram 알림은 실제 Worker 컴퓨트와 Resend 이메일 비용을 발생시킵니다. 월 $5는 지속 가능한 최저가입니다. 무료 티어는 체험판이 아니라 그 자체로 충분히 유용한 플랜입니다." },
    { q: "언제든지 해지할 수 있습니까?", a: "Stripe 고객 포털에서 클릭 한 번으로 해지하실 수 있습니다. \"해지하려면 문의 주세요\" 같은 번거로움이 없습니다. 7일 이내 환불 가능하며, 사유는 묻지 않습니다." },
    { q: "100%에 도달하면 어떻게 됩니까? 요청을 대신 차단해 줍니까?", a: "아닙니다. 저희는 고객님의 서비스를 제어할 권한을 갖지 않으며, 이는 의도된 설계입니다. 80% 시점(기본값, 변경 가능)에 알림을 보내 드리므로, 서비스를 업그레이드하시거나 트래픽을 최적화하시거나 절벽을 감수하시는 등 직접 판단하여 대응하실 수 있습니다." },
  ...
  cta_h2: "하나의 대시보드, 새벽의 한도 초과는 이제 그만.",
  cta_p: "솔로 개발자는 매달 사용량 초과로 적지 않은 시간을 잃습니다. 더는 그러지 않으셔도 됩니다.",
  cta_button: "매직 링크 받기 →",
  footer_tagline: "<strong>FreeTier Sentinel</strong> — 신경 쓰시는 모든 무료 티어 SaaS 한도를 하나의 대시보드로. Cloudflare Workers 위에 1인 개발로 구축된 완전한 오픈소스입니다.",
  footer_product: "제품",
  footer_oss: "오픈소스",
  footer_built: "Cloudflare Workers · D1 · KV 기반 구축",
  footer_signin: "로그인",
};
...
const ja: Translations = {
  ...
  hero_h1_line2: "夜は安心して眠るために。",
  hero_sub_line1: "Datadog のアプローチを、無料枠の上限管理に。",
  hero_sub_line2: "上限到達の前に、使用率 80% でメール通知。",
  hero_email_placeholder: "you@example.com",
  hero_cta: "始める →",
  ...
  features_h2_line1: "無料枠の上で本番サービスを動かす、",
  features_h2_line2: "すべての個人開発者へ。",
  features_sub: "どのクラウドにも使用量ページはあります。けれど、上限の手前で通知してくれるサービスはありません。Sentinel が、その役目を担います。",
  features: [
    { title: "上限到達前のアラート", desc: "しきい値はデフォルト 80%、メールは即時配信。Pro プランでは Discord と Telegram にも対応します。深夜 11 時のサイト障害対応は、もう不要です。" },
  ...
  how_eyebrow: "ご利用の流れ",
  how_h2: "わずか 3 ステップ。深夜の障害通知から解放されます。",
  ...
  steps: [
    ...
    { title: "あとは安心して休むだけ", desc: "Pro プランでは 1 時間ごとに使用量を確認し、しきい値を超えた瞬間に通知します。上限に達した後ではなく、到達する前に。" },
  ],
  pricing_eyebrow: "料金",
  ...
  tier_pro_cta: "無料で始めて、あとからアップグレード",
  ...
  faqs: [
    ...
    { q: "いつでも解約できますか?", a: "Stripe カスタマーポータルからワンクリックで解約いただけます。「解約はお問い合わせください」といった煩わしさはありません。ご利用開始から 7 日以内であれば、理由を問わず返金いたします。" },
    { q: "100% に達した場合、リクエストを止めてくれますか?", a: "いいえ。お客様のサービスを制御する権限は当方に付与されておらず、これは意図的な設計です。80% の時点(デフォルト、変更可能)で通知をお送りしますので、サービスのアップグレード、トラフィックの最適化、あるいは崖を受け入れる、といった対応をお客様ご自身でご判断いただけます。" },
  ...
  cta_h2: "ひとつのダッシュボードで、深夜の上限超過に終止符を。",
  cta_p: "個人開発者は毎月、超過料金のために多くの時間を失っています。もう、その必要はありません。",
  cta_button: "マジックリンクを受け取る →",
  footer_tagline: "<strong>FreeTier Sentinel</strong> — 気になるすべての無料枠 SaaS 上限を、ひとつのダッシュボードに。Cloudflare Workers 上で個人開発、完全オープンソース。",
...
const es: Translations = {
  ...
  hero_sub_line1: "Como Datadog, pero para los límites de los planes gratuitos.",
  hero_sub_line2: "Te avisamos por correo al 80 %, antes de que llegues al tope.",
  ...
  strip_label: "Monitorizando ahora mismo",
  features_eyebrow: "Por qué Sentinel",
  features_h2_line1: "Pensado para desarrolladores independientes",
  features_h2_line2: "que ponen proyectos reales en planes gratuitos.",
  ...
  features: [
    ...
    { title: "Núcleo de código abierto", desc: "El código del Worker está en GitHub. Aloja tú mismo el servicio gratis o paga 5 $ al mes por la versión gestionada con sondeo cada hora." },
  ],
  how_eyebrow: "Cómo funciona",
  how_h2: "Tres pasos. Cero sobresaltos a medianoche.",
  ...
  pricing_sub: "Pro cuesta unos justos 5 $ al mes e incluye sondeo cada hora y alertas en varios canales.",
  tier_per: "/ mes",
  tier_free_label: "Free",
  ...
  tier_pro_features: [
    ...
    "Auto-alojamiento de la versión open source",
  ],
  tier_pro_cta: "Empieza gratis y mejora después",
  ...
  code_p2: "Puedes autoalojar tú mismo la versión de código abierto, o pagar 5 $/mes por la versión gestionada con sondeo cada hora y alertas multicanal.",
  faq_eyebrow: "Preguntas frecuentes",
  faq_h2: "Preguntas comunes.",
  faq_sub: "Si la tuya no aparece, escríbenos sin problema.",
  faqs: [
    { q: "¿Cómo se almacenan mis tokens de API?", a: "Cifrados con AES-256-GCM en Cloudflare D1. La clave maestra reside en Workers Secrets, separada de la base de datos. Solo aceptamos tokens de solo lectura o limitados al ámbito de uso, nunca tokens con permisos de aprovisionamiento o escritura. Si eres de los desconfiados, el código está abierto: léelo tú mismo." },
    ...
    { q: "¿Por qué 5 $ al mes en lugar de ser gratis para siempre?", a: "Sondear cada hora un número ilimitado de servicios y enviar alertas a Discord o Telegram cuesta cómputo real de Workers y un volumen de correo de Resend que crece con la escala. 5 $/mes es el precio más bajo que resulta sostenible. El plan gratuito es genuinamente útil, no una prueba." },
    ...
    { q: "¿Qué pasa al llegar al 100 %? ¿Cortáis vosotros la petición?", a: "No. No tenemos permisos para controlar tus servicios, y es algo deliberado. Te avisamos al 80 % (valor por defecto, configurable) para que puedas actuar: ampliar el servicio, optimizar el tráfico o aceptar el precipicio." },
  ...
  cta_h2: "Un solo panel. Cero sustos a medianoche.",
...
const de: Translations = {
  ...
  hero_h1_line1: "Behalten Sie jedes Free-Tier-Limit im Blick.",
  hero_h1_line2: "Und schlafen Sie ruhig.",
  hero_sub_line1: "Wie Datadog – nur für die Limits Ihrer Free Tiers.",
  hero_sub_line2: "Wir benachrichtigen Sie per E-Mail bei 80 Prozent, bevor das Limit erreicht ist.",
  ...
  hero_micro_3: "Einrichtung in 60 Sekunden",
  ...
  features_sub: "Jede Cloud hat eine Verbrauchsseite. Keine schickt eine E-Mail, bevor das Limit erreicht ist. Wir schon.",
  features: [
    { title: "Benachrichtigung vor dem Limit", desc: "Standardschwellenwert von 80 Prozent. Sofortige E-Mail-Benachrichtigung. Discord und Telegram in der Pro-Version. Schluss mit nächtlichen Ausfällen um 23 Uhr." },
    { title: "Read-only by Design", desc: "Wir verlangen ausschließlich Tokens mit Verbrauchs-Scope. AES-256-GCM-Verschlüsselung im Ruhezustand. Der Master-Key liegt in Workers Secrets und niemals in der Datenbank." },
  ...
  how_h2: "Drei Schritte. Keine Überraschungen mitten in der Nacht.",
  ...
  steps: [
    ...
    { title: "Schwellenwert festlegen", desc: "Standardmäßig liegt der Wert bei 80 Prozent des Free-Tier-Limits. Wählen Sie Ihre Benachrichtigungskanäle: E-Mail (kostenlos), Discord und Telegram (Pro). Mehrere Kanäle pro Konto möglich." },
  ...
  tier_per: "/ Monat",
  tier_free_label: "Free",
  tier_free_sub: "Für Solo-Entwicklerinnen und -Entwickler, die Side Projects validieren.",
  tier_free_features: [
    "Bis zu 3 verbundene Dienste",
    "Polling alle 12 Stunden",
    "E-Mail-Benachrichtigungen",
    "Verbrauchsverlauf über 7 Tage",
    "Magic-Link-Anmeldung, keine Passwörter",
  ],
  ...
  code_p1: "Workers + D1 + KV + Cron Triggers. Das gesamte Produkt läuft im kostenlosen Kontingent jener Cloud, die ihm den Namen gibt. Dogfooding ab Werk.",
  ...
  cta_p: "Solo-Entwicklerinnen und -Entwickler verlieren jeden Monat Stunden durch überschrittene Limits. Das muss nicht sein.",
  cta_button: "Magic Link erhalten →",
  footer_tagline: "<strong>FreeTier Sentinel</strong> — Ein Dashboard für jede Grenze kostenloser SaaS-Kontingente, die Ihnen wichtig ist. Im Alleingang auf Cloudflare Workers entwickelt, vollständig quelloffen.",
