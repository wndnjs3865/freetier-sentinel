...
const en: Translations = {
  ...
  description: "Like Datadog, but for free-tier limits. We email you at 80% — before the cliff. Cloudflare and GitHub Actions live now; Vercel, Supabase, Resend, Render, Neon, R2 shipping over the next 2 weeks.",
  ...
  hero_eyebrow: "Cloudflare + GitHub Actions live. 6 more shipping over the next 2 weeks.",
  ...
  features: [
    ...
    { title: "Multi-cloud aggregate", desc: "Cloudflare and GitHub Actions live now. Vercel, Supabase, Resend, Render, Neon, R2 shipping over the next 2 weeks. Each adapter takes about a day. Want one we don't have? Open an issue." },
  ...
  steps: [
    { title: "Connect a service", desc: "Paste a read-only API token from Cloudflare or GitHub Actions today; six more SaaS shipping over the next 2 weeks. Tokens encrypted at rest." },
...
const ko: Translations = {
  ...
  description: "Datadog과 같지만, 무료 티어 한도를 위한 서비스입니다. 한도에 도달하기 전, 80% 시점에 이메일로 알려 드립니다. 현재 Cloudflare와 GitHub Actions 지원, Vercel·Supabase·Resend·Render·Neon·R2는 향후 2주 내 추가 예정입니다.",
  nav_features: "기능",
  nav_how: "작동 방식",
  nav_pricing: "요금제",
  nav_faq: "FAQ",
  nav_signin: "로그인 →",
  switcher_label: "언어",
  hero_eyebrow: "Cloudflare·GitHub Actions 지원 중. 6개 서비스 향후 2주 내 출시.",
  ...
  features: [
    ...
    { title: "멀티 클라우드 통합", desc: "Cloudflare와 GitHub Actions는 현재 지원 중이며, Vercel·Supabase·Resend·Render·Neon·R2는 향후 2주 내 추가 예정입니다. 어댑터는 보통 하루면 추가됩니다. 지원되지 않는 서비스가 있다면 이슈를 등록해 주세요." },
  ...
  steps: [
    { title: "서비스 연결", desc: "현재는 Cloudflare 또는 GitHub Actions에서 발급한 읽기 전용 API 토큰을 붙여 넣으세요. 향후 2주 내 6개 SaaS 추가 예정. 토큰은 저장 시 암호화됩니다." },
...
const ja: Translations = {
  ...
  description: "Datadog のような存在を、無料枠のために。崖に落ちる前、80% の時点でメールでお知らせします。Cloudflare と GitHub Actions は提供中、Vercel・Supabase・Resend・Render・Neon・R2 は今後 2 週間以内に対応予定。",
  nav_features: "機能",
  nav_how: "ご利用の流れ",
  nav_pricing: "料金",
  nav_faq: "よくある質問",
  nav_signin: "ログイン →",
  switcher_label: "言語",
  hero_eyebrow: "Cloudflare と GitHub Actions 提供中。6 サービスを今後 2 週間以内に追加。",
  ...
  features: [
    ...
    { title: "マルチクラウドを一元管理", desc: "Cloudflare と GitHub Actions は提供中。Vercel・Supabase・Resend・Render・Neon・R2 は今後 2 週間以内に対応予定です。新しいアダプターは通常 1 日で追加可能。未対応のサービスがあれば、Issue でお知らせください。" },
  ...
  steps: [
    { title: "サービスを接続", desc: "現在は Cloudflare または GitHub Actions の読み取り専用 API トークンを貼り付けます。今後 2 週間以内に 6 つの SaaS を追加予定。トークンは保存時に暗号化されます。" },
...
const es: Translations = {
  ...
  description: "Como Datadog, pero para los límites del plan gratuito. Te avisamos por correo al 80 %, antes de llegar al precipicio. Cloudflare y GitHub Actions disponibles ahora; Vercel, Supabase, Resend, Render, Neon y R2 llegarán en las próximas 2 semanas.",
  ...
  hero_eyebrow: "Cloudflare y GitHub Actions disponibles. 6 servicios más en las próximas 2 semanas.",
  ...
  features: [
    ...
    { title: "Vista multinube unificada", desc: "Cloudflare y GitHub Actions disponibles ahora. Vercel, Supabase, Resend, Render, Neon y R2 llegarán en las próximas 2 semanas. Cada adaptador se añade en aproximadamente un día. ¿Te falta alguno? Abre una incidencia en GitHub." },
  ...
  steps: [
    { title: "Conecta un servicio", desc: "Pega hoy un token API de solo lectura desde Cloudflare o GitHub Actions; 6 SaaS más llegarán en las próximas 2 semanas. Los tokens se almacenan cifrados." },
...
const de: Translations = {
  ...
  description: "Wie Datadog, jedoch für die Grenzen kostenloser Kontingente. Wir benachrichtigen Sie per E-Mail bei 80% – bevor es zu spät ist. Cloudflare und GitHub Actions sind jetzt verfügbar; Vercel, Supabase, Resend, Render, Neon und R2 folgen in den nächsten 2 Wochen.",
  ...
  hero_eyebrow: "Cloudflare und GitHub Actions verfügbar. 6 weitere Dienste in den nächsten 2 Wochen.",
  ...
  features: [
    ...
    { title: "Multi-Cloud im Überblick", desc: "Cloudflare und GitHub Actions sind jetzt verfügbar. Vercel, Supabase, Resend, Render, Neon und R2 folgen in den nächsten 2 Wochen. Jeder Adapter ist in rund einem Tag bereit. Sie vermissen einen Dienst? Eröffnen Sie ein Issue auf GitHub." },
  ...
  steps: [
    { title: "Dienst verbinden", desc: "Fügen Sie heute ein schreibgeschütztes API-Token von Cloudflare oder GitHub Actions ein; sechs weitere SaaS folgen in den nächsten 2 Wochen. Tokens werden im Ruhezustand verschlüsselt." },
